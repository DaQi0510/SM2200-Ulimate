...
#define SET_LCD_DC GPIO_SetBits(GPIOF,GPIO_Pin_0)    //  PF0  片选
#define CLR_LCD_DC GPIO_ResetBits(GPIOF,GPIO_Pin_0)

#define SET_LCD_RST GPIO_SetBits(GPIOF,GPIO_Pin_1)    //  PF1  复位
#define CLR_LCD_RST GPIO_ResetBits(GPIOF,GPIO_Pin_1)

#define SET_LCD_SDA GPIO_SetBits(GPIOF,GPIO_Pin_2)   //  PF2  数据位
#define CLR_LCD_SDA GPIO_ResetBits(GPIOF,GPIO_Pin_2)

#define SET_LCD_SCL GPIO_SetBits(GPIOF,GPIO_Pin_3)    //  PF3  数据位
